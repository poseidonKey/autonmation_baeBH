...
# 사원증에 홈페이지 주소를 삽입합니다.
ImageDraw.Draw(template).text(xy=(x_offset, y_offset),
                              text=url, font=smallFont, fill="black")
...
for line in IDs:
    ...
    # 명함에 이름을 삽입합니다.
    ImageDraw.Draw(idcard).text(xy=(x_offset, y_offset),
                                text=name, font=nameFont, fill="black")
    ...
    # 명함에 이름을 삽입합니다.
    ImageDraw.Draw(idcard).text(xy=(x_offset, y_offset),
                                text=division, font=infoFont, fill="black")
